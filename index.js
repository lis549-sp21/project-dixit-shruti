...
function Circle() {
  ...
  // fill vars
  var crFill = [
    ["rgba(10,56,67,0)", "rgba(10,56,67,0.2)"],
    ["rgba(11,67,99,0)", "rgba(11,67,99,0.2)"],
    ["rgba(8,46,49,0)", "rgba(8,46,49,0.2)"],
    ["rgba(7,64,60,0)", "rgba(7,64,60,0.2)"],
  ];
  ...
  this.draw = function () {
    ...
    gradient = con.createRadialGradient(
      this.x,
      this.y,
      0,
      this.x,
